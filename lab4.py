...
class DatasetAnnotationApp(QtWidgets.QMainWindow):
    ...
    def initUI(self):
        ...
        self.next_goodclass_button = QtWidgets.QPushButton("Следующий хороший отзыв", self)
        self.next_badclass_button = QtWidgets.QPushButton("Следующий плохой отзыв", self)
        self.next_goodclass_button.setEnabled(False)
        self.next_badclass_button.setEnabled(False)
        ...
        vbox.addWidget(self.next_badclass_button)
        ...
        self.next_badclass_button.clicked.connect(self.show_bad_reviews)
    ...
    def select_folder(self):
        ...
        if self.folderpath:
            ...
            self.next_badclass_button.setEnabled(True)
    ...
    def show_good_reviews(self):
        if self.folderpath:
            self.current_instance = self.get_next_instance("good", self.folderpath + '/good')
            self.show_instance()

    def show_bad_reviews(self):
        if self.folderpath:
            self.current_instance = self.get_next_instance("bad", self.folderpath + '/bad')
            self.show_instance()
